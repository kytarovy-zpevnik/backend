...
(8,	2,	'Knocking on Heaven\'s Door',	'((1))\nMama, take this badge off of me \nI can\'t use it anymore \nIt\'s gettin\' dark, to dark for me to see \nFeel like I\'m knockin\' on heaven\'s door \n\n((R))\nKnock, knock, knockin\' on heaven\'s door \nKnock, knock, knockin\' on heaven\'s door \nKnock, knock, knockin\' on heaven\'s door \nKnock, knock, knockin\' on heaven\'s door \n\n((2))\nMama, put my guns on the ground \nI can\'t shoot them any more \nThat long black cloud is comin\' down \nFeels like I\'m knockin\' on heaven\'s door \n\n((R))\nKnock, knock, knockin\' on heaven\'s door \nKnock, knock, knockin\' on heaven\'s door \nKnock, knock, knockin\' on heaven\'s door \nKnock, knock, knockin\' on heaven\'s door ',	'Pat Garrett & Billy the Kid', 'Bob Dylan', NULL, 1973, 0, 1, '2014-11-29 10:10:32',	'2014-12-08 14:36:24',	'{\"0\":\"G\",\"6\":\"D\",\"29\":\"Ami\",\"30\":\"F\",\"32\":\"G\",\"40\":\"D\",\"50\":\"C\",\"55\":\"G\",\"68\":\"D\",\"92\":\"Ami\",\"96\":\"G\",\"110\":\"D\",\"131\":\"C\"}', NULL);
...
DROP TABLE IF EXISTS `songbook_sharing`;
CREATE TABLE `songbook_sharing` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `songbook_id` int(11) DEFAULT NULL,
  `user_id` int(11) DEFAULT NULL,
  ...
  CONSTRAINT `FK_7E11CEFEA76ED395` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
  CONSTRAINT `FK_7E11CEFEE9EA4588` FOREIGN KEY (`songbook_id`) REFERENCES `songbook` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
DROP TABLE IF EXISTS `song_sharing`;
CREATE TABLE `song_sharing` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `song_id` int(11) DEFAULT NULL,
  `user_id` int(11) DEFAULT NULL,
  `editable` tinyint(1) NOT NULL,
  ...
  CONSTRAINT `FK_A3EAFD47A76ED395` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
  CONSTRAINT `FK_A3EAFD47A0BDB2F3` FOREIGN KEY (`song_id`) REFERENCES `song` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
